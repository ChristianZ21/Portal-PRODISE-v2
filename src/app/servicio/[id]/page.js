...
export default function ServicioPage({ params }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      {/* ── Sidebar ── */}
      <aside style={{ width: 210, background: 'rgba(5,5,7,0.98)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
        <div style={{ padding: '12px 14px', borderBottom: '1px solid var(--border)' }}>
          <img src="/logo_prodise.png" alt="PRODISE" style={{ height: 30, objectFit: 'contain', mixBlendMode: 'lighten' }} />
        </div>
        <div style={{ padding: '12px 14px', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{ padding: 8, borderTop: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      {/* ── Main ── */}
      <main style={{ flex: 1, padding: '22px 26px', background: 'var(--bg)', overflowY: 'auto' }}>
